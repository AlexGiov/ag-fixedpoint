...
/**
 * @brief Provide _Static_assert fallback for pre-C11 compilers
 *
 * XC32 v1.20 (GCC 4.5.x) does not support C11 _Static_assert.
 * This macro makes it a no-op on such compilers while preserving
 * the compile-time check on C11+ toolchains.
 */
#if !defined(__STDC_VERSION__) || (__STDC_VERSION__ < 201112L)
#ifndef _Static_assert
#define _Static_assert(expr, msg) /* no-op on pre-C11 compilers */
#endif
#endif
